...
namespace Vector2Extensions
{
	public static class Vector2Adjustments
	{
		...
		/// </summary>
		public static Vector2 Digitize(this Vector2 v) => new Vector2(v.x == 0 ? 0 : 1, v.y == 0 ? 0 : 1);
		
		/// <summary>
		/// Returns a new Vector2 with the greatest x value and the greatest y value from the given vectors.
		/// </summary>
		public static Vector2 Max(this Vector2 v, Vector2 v2) => new Vector2(Mathf.Max(v.x, v2.x), Mathf.Max(v.y, v2.y));
		
		/// <summary>
		/// Returns a new Vector2 with the least x value and the least y value from the given vectors.
		/// </summary>
		public static Vector2 Min(this Vector2 v, Vector2 v2) => new Vector2(Mathf.Min(v.x, v2.x), Mathf.Min(v.y, v2.y));
		...
		/// </summary>
		public static Vector2 Sign(this Vector2 v) => new Vector2(Math.Sign(v.x), Math.Sign(v.y));
	}
}