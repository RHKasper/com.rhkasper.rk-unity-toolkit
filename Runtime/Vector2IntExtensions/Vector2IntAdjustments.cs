...
namespace Vector2IntExtensions
{
	public static class Vector2IntAdjustments
	{
		...
		/// </summary>
		public static Vector2Int Digitize(this Vector2Int v) => new Vector2Int(v.x == 0 ? 0 : 1, v.y == 0 ? 0 : 1);
		
		/// <summary>
		/// Returns a new Vector2Int with the greatest x value and the greatest y value from the given vectors.
		/// </summary>
		public static Vector2Int Max(this Vector2Int v, Vector2Int v2) =>
		...
		/// </summary>
		public static Vector2Int Min(this Vector2Int v, Vector2Int v2) =>
			new Vector2Int(Mathf.Min(v.x, v2.x), Mathf.Min(v.y, v2.y));
		
		/// <summary>
		/// Returns the value of the greatest component of this Vector2Int
		/// </summary>
		public static float MaxComponent(this Vector2Int v) => Mathf.Max(v.x, v.y);
		
		/// <summary>
		/// Returns the value of the least component of this Vector2Int
		/// </summary>
		public static float MinComponent(this Vector2Int v) => Mathf.Min(v.x, v.y);
		...
		/// </summary>
		public static Vector2Int Sign(this Vector2Int v) => new Vector2Int(Math.Sign(v.x), Math.Sign(v.y));
	}
}