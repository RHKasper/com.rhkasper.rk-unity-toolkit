...
namespace Vector2IntExtensions
{
	public static class Vector2IntEditComponents
	{
		...
		/// </summary>
		public static Vector2Int WithNegativeX(this Vector2Int v) => new Vector2Int(-v.x, v.y);
		
		/// <summary>
		/// Returns a new Vector2 with the y value of <see cref="v"/> negated, and the x value unchanged
		/// </summary>
		public static Vector2Int WithNegativeY(this Vector2Int v) => new Vector2Int(v.x, -v.y);
	}
}