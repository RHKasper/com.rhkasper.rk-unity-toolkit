...
namespace Vector3Extensions
{
	public static class Vector3Adjustments
	{
		...
		/// </summary>
		public static Vector3 Digitize(this Vector3 v) => new Vector3(v.x == 0 ? 0 : 1, v.y == 0 ? 0 : 1, v.z == 0 ? 0 : 1);
		
		/// <summary>
		/// Returns a new Vector3 with the greatest x value, greatest y value, and greatest z value from the two vectors passed in.
		/// </summary>
		public static Vector3 Max(this Vector3 v, Vector3 v2) => new Vector3(Mathf.Max(v.x, v2.x), Mathf.Max(v.y, v2.y), Mathf.Max(v.z, v2.z));
		
		/// <summary>
		/// Returns a new Vector3 with the least x value, least y value, and least z value from the two vectors passed in.
		/// </summary>
		public static Vector3 Min(this Vector3 v, Vector3 v2) => new Vector3(Mathf.Min(v.x, v2.x), Mathf.Min(v.y, v2.y), Mathf.Min(v.z, v2.z));
