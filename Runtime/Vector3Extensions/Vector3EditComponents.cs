...
namespace Vector3Extensions
{
	public static class Vector3EditComponents
	{
		...
		/// </summary>
		public static Vector3 WithNegativeX(this Vector3 v) => new Vector3(-v.x, v.y, v.z);
		
		/// <summary>
		/// Returns a new Vector3 with the y value of <see cref="v"/> negated, and the x and z values unchanged
		/// </summary>
		public static Vector3 WithNegativeY(this Vector3 v) => new Vector3(v.x, -v.y, v.z);
		
		/// <summary>
		/// Returns a new Vector3 with the z value of <see cref="v"/> negated, and the x and y values unchanged
		/// </summary>
		public static Vector3 WithNegativeZ(this Vector3 v) => new Vector3(v.x, v.y, -v.z);
	}
}