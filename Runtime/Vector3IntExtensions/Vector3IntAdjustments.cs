...
namespace Vector3IntExtensions
{
	public static class Vector3IntAdjustments
	{
		...
		/// </summary>
		[Pure] public static Vector3Int Abs(this Vector3Int v) =>
		...
		/// </summary>
		[Pure] public static Vector3Int Digitize(this Vector3Int v) => new Vector3Int(v.x == 0 ? 0 : 1, v.y == 0 ? 0 : 1, v.z == 0 ? 0 : 1);
		
		/// <summary>
		/// Returns a new Vector3Int with the greatest x value, greatest y value, and greatest z value from the two vectors passed in.
		/// </summary>
		[Pure] public static Vector3Int Max(this Vector3Int v, Vector3Int v2) => new Vector3Int(Mathf.Max(v.x, v2.x), Mathf.Max(v.y, v2.y), Mathf.Max(v.z, v2.z));
		
		/// <summary>
		/// Returns a new Vector3Int with the least x value, least y value, and least z value from the two vectors passed in.
		/// </summary>
		[Pure] public static Vector3Int Min(this Vector3Int v, Vector3Int v2) => new Vector3Int(Mathf.Min(v.x, v2.x), Mathf.Min(v.y, v2.y), Mathf.Min(v.z, v2.z));
		
		/// <summary>
		/// Returns the value of the greatest component of this Vector3Int
		/// </summary>
		[Pure] public static float MaxComponent(this Vector3Int v)
		{
		...
		/// </summary>
		[Pure] public static float MinComponent(this Vector3Int v)
		{			
		...
		/// </summary>
		[Pure] public static Vector3Int Sign(this Vector3Int v) =>
